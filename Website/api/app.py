...
def home():
    ...
    try:
        ...
        ingredients_list = [ing.strip() for ing in ingredients_list if ing and ing.strip()]
...
def fileUpload():
    try:
        print("Inside image processing function")
        ...
        # Prepare response with default images
        ans = {"0": []}
        image_urls = [
        ...
        for i, url in enumerate(image_urls):
            recipe = {
                'author': f'Recipe {i+1} from Image',
                'title': 'Ingredients:\n• Ingredient 1\n• Ingredient 2\n• Ingredient 3',
